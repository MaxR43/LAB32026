...
class Program
{
    static void Main(string[] args)
    {
        // --- CONSTANTES DE IDENTIDAD Y REGLAS ---
            ...
            const int valorEntrada = 500;
            Console.WriteLine("Valor de la entrada: $" + valorEntrada);
            Console.WriteLine("Precio con descuento: $" + (valorEntrada * 0.8));

            const bool descuentoActivo = true;
            Console.WriteLine("¿Descuento activo? " + descuentoActivo);
